...
export class GUIProfiles extends GUISubscreen {
  ...
  LoadProfile(profileId: number) {
    ...
    if (Player && Player.OnlineSettings && (!Player.OnlineSettings.BCResponsive || !Player.OnlineSettings.BCResponsive.Profiles[profileId])) {
      Player?.OnlineSettings?.BCResponsive?.Profiles[profileId];
    }
    if (Player && Player.OnlineSettings) {
  ...
  DeleteProfile(profileId: number) {
    ...
    if (
      ...
      (Player.OnlineSettings.BCResponsive?.Profiles || Player.OnlineSettings?.BCResponsive?.Profiles[profileId]) &&
