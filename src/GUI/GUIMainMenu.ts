...
import { BExit, Title, getYPos } from "./GUIMisc/GUIDefinition";
...
export class GUIMainMenu extends GUISubscreen {
    Run(): void {
        ...
        DrawButton(Title.X, getYPos(0), 400, 80, "", "White");
		DrawImageResize("Icons/Preference.png", Title.X + 10, getYPos(0) + 10, 60, 60);
	    DrawTextFit(Localization.GetText("button_settings"), Title.X + 80, getYPos(0) + 40, 320, "Black");
    ...
    Click(): void {
        ...
        if (MouseIn(Title.X, getYPos(0), 400, 80)) setSubscreen(new GUISettings());
