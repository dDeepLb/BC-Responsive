...
export const BCR_CMDS =
    /*html*/`
    <p id='BCR_Cmds' style='background-color:#202020; color: #eee; border: 2px solid #440171 !important; padding-left: 5px'><b style='color:#440171; text-shadow: 0.05em 0.05em #eee;'>BC Responsive</b>: Available commands (Clickable):
...
export const BCR_CHANGELOG =
    /*html*/`
    <p id='BCR_Changelog' style='background-color:#202020; border: 2px solid #440171 !important; padding-left: 5px'><b>0.4.9</b>
...
export const BCR_VERSION_MSG =
    /*html*/`
    <div style='background-color:#202020; border: 2px solid #440171 !important; padding-left: 5px'><b style='color:#440171; text-shadow: 0.05em 0.05em #eee;'>BC Responsive: v${ModVersion}</b>
    </div>
    `;

export const BCR_TOGGLE_ENABLED =
    /*html*/`
    <p style='background-color:#202020; border: 2px solid #440171 !important; padding-left: 5px'><b>BC Responsive</b> has been enabled</p>
    `;

export const BCR_TOGGLE_DISABLED =
    /*html*/`
