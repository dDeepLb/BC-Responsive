...
export const BCR_NEW_VERSION =
    ...
    `<b style='color:#440171; text-shadow: 0.05em 0.05em #eee;'>BC Responsive</b><b style='color:#eee'>: New Version!</b> [${ResponsiveVersion}]
    <br><b style='color:#CC3232; text-shadow: 0.05em 0.05em #eee;'>Please, reload your page~</b>
...
export const BCR_CHANGELOG =
    ...
    <br>Fixed Orgasm trigger Char Talk
    <br><b>0.4.6</b>
    ...
    <br>Added profile names on saving
    <br><b>0.4.5</b>
    <br>Fixed Shark Boop call Pain and Head Pat - Boop
    <br>Added single reset buttons to Responses Menu<br>
